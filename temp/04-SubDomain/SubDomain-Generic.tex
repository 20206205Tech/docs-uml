...
\begin{itemize}
\item Người dùng đăng ký tài khoản với Email hoặc đăng nhập bằng Email, Google
...
\begin{itemize}
\item Hiển thị các gói thuê bao VIP và mức giá



\item Quản lý các gói thuê bao VIP (Cần vai trò ADMIN)


   \item Người dùng mua gói thuê bao VIP để nâng cấp tài khoản
